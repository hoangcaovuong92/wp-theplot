			...
			<div class="item-content<?php echo is_sticky()? ' sticky' : ''?>">
								...
								case 'video':
									if(strlen(trim($_post_config['video_url'])) > 0){
										$video_url = trim($_post_config['video_url']);
											if (!empty($video_url)) {												
												echo tvlgiao_wpdance_wd_get_embbed_video( $video_url, 1200,240 );
											}
										}
										break;
									case 'audio':
				...
				<div class="meta-post post-info-content">
					...
					<p class="excerpt"><?php 
						...
						tvlgiao_wpdance_the_excerpt_max_words($words_limit,$post); ?>
					</p>
					<?php endif;?>
			...
			var ajaxUrl = "<?php echo admin_url('admin-ajax.php', null); ?>";
				...
				jQuery("#more_posts").on("click",function(){ // When btn is pressed.
						jQuery.post(ajaxUrl, {
							...
							jQuery('#<?php echo esc_attr($id_widget);?>').append( $newItems ).isotope( 'insert', $newItems );
