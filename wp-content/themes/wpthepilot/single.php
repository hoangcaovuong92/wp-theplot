					...
					<?php	
						...
						?>
							...
							<div <?php post_class("single-post");?>>
								...
								<div class="post_inner">	
									...
									<div class="post-info-meta-top post-info-meta">									
										...
										if(isset($tvlgiao_wpdance_wd_data['wd_blog_details_comment']) && absint($tvlgiao_wpdance_wd_data['wd_blog_details_comment']) == 1) {
										 ...
										 if( absint($tvlgiao_wpdance_wd_data['wd_blog_details_comment']) == 1 ) : ?>
								...
								<!--Category List-->
									<?php if( $tvlgiao_wpdance_wd_data['wd_blog_details_categories'] == 1 ) : ?>
										...
										<?php
											...
											$categories_list = get_the_category_list( __( ', ', 'wpnoone' ) );
												if ( $categories_list ):
											?>
											<div class="categories">
												<span class="cat-links">
													<?php printf( wp_kses_post( '<span class="%1$s heading-title">Categories:</span> %2$s', 'wpnoone' ), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list );?>
												</span>
											</div>
										...
										<?php
											...
											?>
												<div class="tags">
													...
													<span class="tag-title"><?php esc_html_e('Tags:','wpnoone');?></span>
													<span class="tag-links">
														<?php //_e( '<span class="entry-utility-prep entry-utility-prep-tag-links"></span>'.$tags_list, 'wpnoone' );  ?>
														<?php printf( wp_kses_post( '%s', 'wpnoone' ), $tags_list );
														$show_sep = true; ?>
													</span>
													<?php endif;?>
								...
								<div class="navi">
									<div class="navi-prev"><?php previous_post_link('%link', 'Previous Post'); ?> </div>
									<div class="navi-next"><?php next_post_link('%link', 'Next Post'); ?></div>
								</div>
							</div>
