...
<ul class="list-posts">
	<?php	
	$count=0;
	if(have_posts()) : while(have_posts()) : the_post();$count++;global $wp_query;
			if($count == 1) 
				$_sub_class =  " first";
		...
		<li <?php post_class("home-features-item". esc_attr($_sub_class));?>>
			...
			<div class="post-info-thumbnail">
					...
					<div class="thumbnail-content">
						...
						<?php 
							...
							if( $video_url!= ''){
								echo tvlgiao_wpdance_wd_get_embbed_video( $video_url, 420, 300 );
							}
							else{
								?>
			...
			<div class="post-info-content">
				...
				<div class="post-info-meta">	
					<span class="author">
						<i class="fa fa-user"></i><?php //_e('Post by','wpnoone')?><?php the_author_posts_link(); ?>
					</span>
				...
				<div class="short-content">
					...
					<?php //tvlgiao_wpdance_the_excerpt_max_words($words_limit,$post); ?>
					<?php
						/* translators: %s: Name of current post */
						the_content( sprintf(
							__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'wpnoone' ),
							the_title( '<span class="screen-reader-text">', '</span>', false )
						) );

						wp_link_pages( array( 'before' => '<div class="wp-pagenavi"><span class="page-links-title">' . esc_html__( 'Pages:', 'wpnoone' ) . '</span>', 'after' => '</div>', 'link_before' => '<span class="pager">', 'link_after' => '</span>' ) );
					?>
