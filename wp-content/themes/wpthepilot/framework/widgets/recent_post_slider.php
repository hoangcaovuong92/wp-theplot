					...
					<div class="item<?php //if($i == 0) echo ' first';?><?php //if(++$i == $num_count) echo ' last';?>">
						<div class="detail">
							<div class="post_thumbnail_wrapper">
								<div class="post_thumbnail">
									...
									<?php if(has_post_thumbnail()){ ?>
										...
										<?php echo get_the_post_thumbnail(  $the_query->post->ID, 'tvlgiao_wpdance_blog_recent');?>
									<?php } else { ?>	
							...
							<div class="entry-title">
								...
								<p class="entry-desc">
									<?php echo tvlgiao_wpdance_the_excerpt_max_words(10, $the_query->post);?>
								</p>
							</div>
							<div class="author"><?php esc_html_e('POST BY','wpnoone');?> <?php the_author_posts_link();?></div>
						</div><!-- .detail -->
