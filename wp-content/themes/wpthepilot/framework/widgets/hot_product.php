...
if(!class_exists('WP_Widget_Hot_Product')){
	class WP_Widget_Hot_Product extends WP_Widget {
		...
		function widget( $args, $instance ) {
			extract( $args );
			$title = apply_filters('widget_title', empty($instance['title_popular']) ? esc_html__('Hot Products','wpnoone') : $instance['title_popular']);
	...
	?>
				<p><label for="<?php echo esc_attr($this->get_field_id('title_popular')); ?>"><?php esc_html_e( 'Title for popular tab:','wpnoone' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('hot_type')); ?>"><?php esc_html_e( 'Type:','wpnoone' ); ?></label>
				...
				<p><label for="<?php echo esc_attr($this->get_field_id('num_popular')); ?>"><?php esc_html_e( 'The number of popular post','wpnoone' ); ?>:</label>
