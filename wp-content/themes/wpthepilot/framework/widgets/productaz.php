...
if(!class_exists('WP_Widget_Productaz')){
	class WP_Widget_Productaz extends WP_Widget {
		function __construct() {
			$widget_ops = array('classname' => 'widget_productaz', 'description' => esc_html__( 'This widget show list a-z of your products','wpnoone') );
			
			add_action ('pre_get_posts',array($this,'add_a2z_query'),9);
			
			parent::__construct('productaz', esc_html__('WD - Product A to Z','wpnoone'), $widget_ops);
		}
