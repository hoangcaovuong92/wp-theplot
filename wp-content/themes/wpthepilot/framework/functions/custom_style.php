<?php
	...
	function tvlgiao_wpdance_include_cache_css(){
		...
		$upload_dir = wp_upload_dir();
		//$filename = trailingslashit($upload_dir['baseurl']) .TVLGiao_Wpdance_THEME_SLUG.'theme/custom.css';
		//$filename_dir = trailingslashit($upload_dir['basedir']) .''.TVLGiao_Wpdance_THEME_SLUG.'theme/custom.css';
