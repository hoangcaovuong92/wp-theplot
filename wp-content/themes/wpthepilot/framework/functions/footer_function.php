<?php 
	add_action( 'tvlgiao_wpdance_wd_footer_init', 'tvlgiao_wpdance_wd_footer_init_widget_area_1', 10 );
	if(!function_exists ('tvlgiao_wpdance_wd_footer_init_widget_area_1')){
		function tvlgiao_wpdance_wd_footer_init_widget_area_1(){
	...
	add_action( 'tvlgiao_wpdance_wd_footer_init', 'tvlgiao_wpdance_wd_footer_init_widget_area_2', 15 );
	if(!function_exists ('tvlgiao_wpdance_wd_footer_init_widget_area_2')){
		function tvlgiao_wpdance_wd_footer_init_widget_area_2(){
			global $tvlgiao_wpdance_wd_data;
		?>
	...
	add_action( 'tvlgiao_wpdance_wd_footer_init', 'tvlgiao_wpdance_wd_footer_init_widget_area_3', 20 );
	if(!function_exists ('tvlgiao_wpdance_wd_footer_init_widget_area_3')){
		function tvlgiao_wpdance_wd_footer_init_widget_area_3(){
			global $tvlgiao_wpdance_wd_data;
	?>	
