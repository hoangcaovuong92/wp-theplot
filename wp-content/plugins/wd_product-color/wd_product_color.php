...
class WD_Widget_PC_Color_Nav extends WP_Widget {
	...
	function __construct() {
    	$widget_setting = array(
			'name' 		=> esc_html__('WD - Color Layered Nav','wpdance'),
			'desc' 		=> esc_html__('Shows a color attribute in a widget which lets you narrow down the list of products when viewing product categories.','wpdance'),
			'slug' 	  	=> 'wpdance_color_nav',
			'class' 	=> 'wpdance widget_wd_pc_color_nav',
		);
