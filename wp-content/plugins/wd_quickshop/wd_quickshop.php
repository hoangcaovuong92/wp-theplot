...
<?php
	...
	public function init_script(){
		...
		wp_register_script( 'jquery.owl-carousel', QS_JS.'/owl.carousel.min.js',false,false,true );
...
$tvlgiao_wpdance_wd_quickshop = new WD_Quickshop; // Start an instance of the plu