...
if(!function_exists('wd_featured_products')){
	function wd_featured_products($atts,$content){
		...
		if ( $products->have_posts() ) : ?>
			...
			<?php tvlgiao_wpdance_wd_woocommerce_product_loop_start($style); ?>
				...
				if(absint($show_number)) add_action('wd_product_loop_before', 'tvlgiao_wpdance_wd_add_number_product_list');?>
				<?php while ( $products->have_posts() ) : $products->the_post(); ?>
				...
				<?php endwhile; // end of the loop. ?>
				<?php remove_action('wd_product_loop_before', 'tvlgiao_wpdance_wd_add_number_product_list');?>
				<?php if($style == 'widget'):?>
				</div>
				<?php endif;?>
