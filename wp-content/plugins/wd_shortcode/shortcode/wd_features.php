						...
						<div class="container">
							...
							<?php if($show_title):?>
								<h2 class="feature_title heading_title bold-upper-big ">
									<strong><a href="<?php echo esc_url($_feature->url);?>"><?php the_title(); ?></a></strong>
								</h2>	
							...
							<?php if($show_excerpt) :?>
								<div class="feature_excerpt text-strong">
									<?php tvlgiao_wpdance_the_excerpt_max_words(absint($excerpt_words)); ?>
								</div>
							<?php endif;?>
							</div>
						</div>
					...
					foreach( $_feature as $feature ){
						...
						<div class="feature-item feature">
							<div class="avartar">
								...
								if(has_post_thumbnail()) the_post_thumbnail('tvlgiao_wpdance_blog_shortcode');
								else {
								?>
