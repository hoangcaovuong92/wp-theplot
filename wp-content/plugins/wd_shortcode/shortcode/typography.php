...
if(!function_exists ('heading_function')){
	function heading_function($atts, $content = null){
		...
		return "<div class='heading-title-block {$style}'><{$size}><span class='title-text'>".do_shortcode($content)."</span><span class='icon'><i class='{$icon_fontawesome} {$icon_openiconic} {$icon_typicons} {$icon_entypo} {$icon_linecons}'></i></span></{$size}></div>";				
	}
}
