...
if(!function_exists ('bt_slides_funcs ')){
	function bt_slides_funcs($atts,$content){
		...
		$portfolio_sliders = get_post_meta($id,TVLGiao_Wpdance_THEME_SLUG.'_portfolio_slider',true);
		$portfolio_sliders = unserialize($portfolio_sliders);

		$portfolio_slider_config = get_post_meta($id,TVLGiao_Wpdance_THEME_SLUG.'_portfolio_slider_config',true);
