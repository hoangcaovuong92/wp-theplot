		...
		if($post->post_type=='page' || $post->post_type=='page'){
			...
			if(strlen($items_id)>0){
				...
				if($display_style == 'service-style1'){
					...
					$meta = get_post_meta($items_id, TVLGiao_Wpdance_THEME_SLUG.'ew_service_custom_logo', true);
					$metaLink = get_post_meta($items_id, TVLGiao_Wpdance_THEME_SLUG.'ew_service_custom_link', true);
