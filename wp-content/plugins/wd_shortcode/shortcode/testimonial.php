					...
					?>
						<li class="estimonial-item <?php if($count==$about->post_count) echo " last";?>">
							...
							<div class="detail">
								...
								<div class="name">
										<a href="#"><?php echo get_post_meta($post->ID,TVLGiao_Wpdance_THEME_SLUG.'nametestimonial',true);?></a>
								</div>	
							</div>						
							<?php }?>
							<?php  if($style=='style2'){?>							
							<div class="detail">
								...
								<div class="job">
										<a href="#"><?php echo get_post_meta($post->ID,TVLGiao_Wpdance_THEME_SLUG.'jobtestimonial',true);?></a>
								</div>
								<div class="testimonial-content"><?php the_content();?></div>
							</div>						
							<?php }?>
