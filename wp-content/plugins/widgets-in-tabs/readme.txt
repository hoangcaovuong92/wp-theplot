...
* Known Issue: Using multiple instances of WIT widget that display the same WIT area on the same page breaks all WIT instances on that page.
...
= 2.2.1 =
Bug fixes and performance improvements. Read the change log for an important known bug that is not yet fixed.
